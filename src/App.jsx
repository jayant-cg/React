  ...
  return (
    <main className="app-shell">
      ...
      <header className="hero">
        ...
        <p className="hero-copy">A tiny app showing props, state, lists, conditional rendering, controlled input, and useEffect.</p>
      </header>

      <section className="status-panel">
        <label className="status-label" htmlFor="status-input">
          Your current status
        </label>
        <input
          id="status-input"
